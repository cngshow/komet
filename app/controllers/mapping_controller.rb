...
class MappingController < ApplicationController
  ...
  def mapping
    ...
    if true #!session['map_set_data']
      ...
      session['map_set_data'] = [{id: '1', name: 'Test 1', purpose: 'Test 1', description: 'Test 1 Description', review_state: 'Pending', status: 'Active', time: '10/10/2016', module: 'Development', path: 'Path'},
                       {id: '2', name: 'Test 2', purpose: 'Test 2', description: 'Test 2 Description', review_state: 'Pending', status: 'Active', time: '10/10/2016', module: 'Development', path: 'Path'}]
