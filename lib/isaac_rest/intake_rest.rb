...
module IntakeRest
  ...
  ACTION_CONSTANTS = {
    ACTION_VETS_XML => {
      ...
      CALLBACKS => [IntakeRest.clear_lambda, -> do ApplicationController.new.clear_rest_caches end]#not needed, only gets are cached (I forgot this), second callback  #defaults to CACHE_TYPE_TAXONOMY
    }
  }
