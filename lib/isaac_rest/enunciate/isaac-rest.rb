                                ...
                                def init_jaxb_json_hash(_o)
                                    if !_o['endInclusive'].nil?
                                        ...
                                        if(_oa.is_a? Hash)
                                            ...
                                            @endInclusive =  Fixnum.from_json(_oa) unless _oa['@class']
                                        elsif (_oa.is_a? Array)
                                            #an array(of hashes hopefully) or scalar
                                            @endInclusive = Array.new
                                            _oa.each { | _item |
                                                if ((_item.nil? || _item['@class'].nil?)rescue true)
                                                    @endInclusive.push Fixnum.from_json(_item)
                                                else
                                    ...
                                    if !_o['startInclusive'].nil?
                                        ...
                                        if(_oa.is_a? Hash)
                                            ...
                                            @startInclusive =  Fixnum.from_json(_oa) unless _oa['@class']
                                        elsif (_oa.is_a? Array)
                                            #an array(of hashes hopefully) or scalar
                                            @startInclusive = Array.new
                                            _oa.each { | _item |
                                                if ((_item.nil? || _item['@class'].nil?)rescue true)
                                                    @startInclusive.push Fixnum.from_json(_item)
                                                else
                ...
                module Api
                    ...
                    module Data
                        ...
                        class RestXML
                            ...
                            # the json hash for this RestXML
                            def to_jaxb_json_hash
                                _h = {}
                                _h['xml'] = xml.to_jaxb_json_hash unless xml.nil?
                                return _h
                            end

                            # the json (string form) for this RestXML
                            def to_json
                                to_jaxb_json_hash.to_json
                            end

                            #initializes this RestXML with a json hash
                            def init_jaxb_json_hash(_o)
                                if !_o['xml'].nil?
                                    _oa = _o['xml']
                                    if(_oa.is_a? Hash)
                                        @xml = EnunciateHelpers::LAMB_CLASS_AWARE.call(_oa) if _oa['@class']
                                        @xml =  String.from_json(_oa) unless _oa['@class']
                                    elsif (_oa.is_a? Array)
                                        #an array(of hashes hopefully) or scalar
                                        @xml = Array.new
                                        _oa.each { | _item |
                                            if ((_item.nil? || _item['@class'].nil?)rescue true)
                                                @xml.push String.from_json(_item)
                                            else
                                                @xml.push EnunciateHelpers::LAMB_CLASS_AWARE.call(_item)
                                            end
                                        }
                                    else
                                        @xml = _oa
                            ...
                            # constructs a RestXML from a (parsed) JSON hash
                            def self.from_json(o)
                                if o.nil?
                                    return nil
                                else
