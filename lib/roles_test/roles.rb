...
module RolesTest
  def self.user_roles(user:, password:)
    users_development = [['devtest', 'devtest',[::Roles::ADMINISTRATOR, ::Roles::FINAL_APPROVER, ::Roles::EDITOR]], ['cris', 'cris', [::Roles::APPROVER, ::Roles::REVIEWER]], ['greg', 'greg', [::Roles::DEV_SUPER_USER, ::Roles::EDITOR]]]
